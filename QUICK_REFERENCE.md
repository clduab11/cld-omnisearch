...
- **Critical Fix Applied**: Corrected `GITHUB_TOKEN` →
  `GITHUB_API_KEY`
- **Ready for Msty Studio**: All configurations verified against
  source code
...
Msty Studio will automatically use **v0.1.1** with the corrected
configuration!
