...
This guide provides step-by-step instructions for setting up **CLD
Omnisearch** MCP server in Msty Studio Desktop and Web.
...
1. **Node.js** (v18 or later)
   - Install via [Volta](https://volta.sh/) (recommended) or
...
3. **Msty Studio Desktop** or **Msty Studio Web + Sidecar**
   ...
   - For Web, see
     [Sidecar setup guide](https://docs.msty.studio/getting-started/sidecar)

### Optional: API Keys

CLD Omnisearch supports multiple search and AI providers. You only
need API keys for the providers you want to use:
...
3. **Tool Configuration**
   ...
   **Note**: The `env` object is empty because we're using Msty
   Environments.
...
1. Start a new conversation with an SOTA model (e.g., Claude 3.5
   Sonnet, GPT-4, etc.)
...
Follow the
[official Sidecar guide](https://docs.msty.studio/getting-started/sidecar)
...
2. **Enable Tool Use in Conversation**
   ...
   - Try: "You have access to search tools. Please use them to answer
     my question."
