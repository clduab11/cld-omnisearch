...
When you click **"Add New Tool"** in Msty Studio, use this **verified
...
- Test with: _"Search the web for the latest AI news"_
...
- ✅ **Published to npm registry**:
  https://www.npmjs.com/package/cld-omnisearch
...
- **Verification Report**:
  [TOOL_VERIFICATION.md](./TOOL_VERIFICATION.md)
...
Copy the complete configuration above and paste it into Msty Studio's
"Add New Tool" dialog. The tool will automatically fetch v0.1.1 from
npm and be ready to use!
